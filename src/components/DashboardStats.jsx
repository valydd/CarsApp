    ...
    <div className="space-y-2 sm:space-y-3 mb-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-2.5">
        ...
        <div 
          ...
          className="bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-200/70 dark:border-emerald-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-emerald-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        <div 
          ...
          className="bg-purple-100/50 dark:bg-purple-950/30 border border-purple-200/75 dark:border-purple-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-purple-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        <div 
          ...
          className="bg-amber-50/75 dark:bg-amber-950/30 border border-amber-200/70 dark:border-amber-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-amber-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        <div 
          ...
          className="bg-teal-50/70 dark:bg-teal-950/30 border border-teal-200/70 dark:border-teal-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-teal-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        <div 
          ...
          className="bg-indigo-100/45 dark:bg-indigo-950/30 border border-indigo-200/75 dark:border-indigo-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-indigo-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        {/* 6. Consum Mediu - Sky (UN TON PESTE CA INTENSITATE) (Col 2, Rând 3) */}
        <div 
          onClick={() => onNavigateTab && onNavigateTab('fuel')}
          className="bg-sky-100/80 dark:bg-sky-900/40 border border-sky-300/80 dark:border-sky-700/60 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-sky-400/80 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
          title={t.fuelConsumptionTitle || "Apasă pentru date despre carburant & consum"}
        >
          <div className="flex items-center justify-between mb-0.5">
            <span className="text-[11px] font-bold text-sky-900 dark:text-sky-200 truncate">
              {selectedVehicle 
            ...
            <div className="p-1 rounded-xl bg-sky-500/20 text-sky-700 dark:text-sky-300 group-hover:bg-sky-500/30 transition-colors shrink-0">
          ...
          <div>
            <div className="text-base sm:text-lg font-black text-slate-900 dark:text-white tracking-tight">
              {avgConsumption ? (
                <>
                  {avgConsumption} <span className="text-[10px] font-bold text-sky-700 dark:text-sky-300">L/100</span>
                </>
              ) : (
                <span className="text-sm font-bold text-slate-400 dark:text-slate-500">—</span>
              )}
            ...
            <div className="mt-0.5 flex items-center text-[10px] text-slate-500 dark:text-slate-400 truncate">
              <span className="truncate text-sky-700 dark:text-sky-300 font-bold">
        ...
        <div 
          ...
          className="bg-orange-50/75 dark:bg-orange-950/30 border border-orange-200/70 dark:border-orange-800/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-orange-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        {/* 8. Curse Weekend & Personal - Rose (UN TON PESTE CA INTENSITATE) (Col 2, Rând 4) */}
        <div 
          onClick={() => onNavigateTab && onNavigateTab('personal')}
          className="bg-rose-100/80 dark:bg-rose-900/40 border border-rose-300/80 dark:border-rose-700/60 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-rose-400/80 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
          title={t.personalTripsTitle || "Apasă pentru evidență consum & decontare curse personale"}
        >
          <div className="flex items-center justify-between mb-0.5">
            <span className="text-[11px] font-bold text-rose-900 dark:text-rose-200 truncate">
              {t.weekendTrips || t.personalTrips || "Curse Weekend"}
            </span>
            <div className="p-1 rounded-xl bg-rose-500/20 text-rose-700 dark:text-rose-300 group-hover:bg-rose-500/30 transition-colors shrink-0">
          ...
          <div className="flex items-end justify-between gap-1.5 mt-auto">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex items-center text-[10px] text-slate-500 dark:text-slate-400 truncate">
                <span className="truncate text-rose-700 dark:text-rose-300 font-bold">
            ...
            {onOpenAddPersonalTrip && (
              <button
                ...
                className="w-7.5 h-7.5 sm:w-8 sm:h-8 rounded-full bg-rose-200/90 hover:bg-rose-300 text-rose-800 dark:bg-rose-900/80 dark:hover:bg-rose-800 dark:text-rose-200 border border-rose-400/70 dark:border-rose-600/60 shadow-xs hover:scale-105 active:scale-95 transition-all cursor-pointer flex items-center justify-center shrink-0 mb-0.5"
        ...
        <div 
          ...
          className="bg-lime-50/40 dark:bg-lime-950/25 border border-lime-200/50 dark:border-lime-800/40 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-lime-400/50 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
        ...
        <div 
          ...
          className="bg-slate-100/70 dark:bg-slate-800/35 border border-slate-300/65 dark:border-slate-700/50 rounded-2xl flex flex-col justify-between min-h-[104px] sm:min-h-[109px] p-2.5 sm:p-3 relative overflow-hidden group hover:border-slate-400/60 transition-all shadow-xs cursor-pointer active:scale-[0.98]"
